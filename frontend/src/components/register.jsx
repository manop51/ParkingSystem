...
var response = await axios.post("http://localhost:4500/create/users",Payload)
...
<strong>Register For Parking</strong>
<div>
<input type="text" placeholder="Enter Your name eg Joe Doe"  onChange={(e)=>setName(e.target.value)} required/>
</div>
<div>
<input type="email" placeholder="Enter Your Email" required onChange={(e)=>setEmail(e.target.value)} />
</div>
<div>
<input type="text" placeholder="Enter Your phonenumber eg 254*******"  onChange={(e)=>setPhone(e.target.value)} required maxLength={12}/>
</div>
<div>
<input type={seePassword ? "text":"password"}  placeholder="Enter Your Password"  onChange={(e)=>{setPassword(e.target.value)}}
...
<button disabled = {!ValidatePhoneformat()}>
Register
</button>
</form>
)}
...
<Link to="/"><p>Got an Account ?</p></Link>
